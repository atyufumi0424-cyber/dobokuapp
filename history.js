...
function loadRoadmark(){if(document.querySelector('script[data-roadmark]'))return;const s=document.createElement('script');s.src='./roadmark.js?ts='+Date.now();s.defer=true;s.dataset.roadmark='1';document.head.appendChild(s)}
